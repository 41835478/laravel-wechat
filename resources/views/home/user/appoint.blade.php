    ...
    <div class="a_tab">
        ...
        <div class="a_list a_bywx">
        	<form method="get" action="{{ route('api.appointMaintenance') }}">
                <div class="a_form1">
                    <input class="txt01" type="text" onclick="javascript:window.location.href='{{ url('shop') }}'" value="@if($type=='station'){{ $name }} @endif" placeholder="请选择专营店／输入地址"/>
        ...
        <div class="a_list a_yysj" style="display: none;">
        	<form method="get" action="{{ route('api.appointTestDrive') }}">
                <div class="a_form2">
                    ...
                    <input class="txt01" type="text" onclick="javascript:window.location.href='{{ url('station') }}'" value="@if($type=='shop'){{ $name }} @endif" placeholder="请选择专营店／输入地址"/>
