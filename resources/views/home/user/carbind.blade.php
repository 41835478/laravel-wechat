...
<div class="wrapper">
    ...
    <form method="get">
    	<div class="c_form">
        	<input class="txt01" type="text" name="" placeholder="请输入车架号后8位"/>
            <input class="txt02" type="text" name="" placeholder="请输入手机号码"/>
            <input class="txt03" type="text" name="" placeholder="请输入下方图片上的验证码"/>
    	</div>
        <div class="c_code">
        	<div class="c_code01"><img src="images/code.png"/></div>
            <div class="c_code02">
            	<p>车辆绑定后违章查询</p>
