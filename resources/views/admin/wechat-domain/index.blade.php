...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <a class="btn btn-primary" href="{{ route('admin.wechat-domain.create') }}">添加域名</a>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-bordered table-striped" id="example-2">
                        ...
                        <tbody class="middle-align">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('admin.wechat-domain.edit',$item->id)}}" class="btn btn-secondary btn-sm btn-icon icon-left">
                                        编辑
                                    </a>

                                    {!! Form::open(['route'=>['admin.wechat-domain.destroy',$item->id],'role'=>'form','class'=>'form-horizontal','method'=>'delete','style'=>'display:inline']) !!}
