    ...
    <div class="a_tab">
        ...
        <div class="a_list a_bywx">
        	<form method="get" action="{{ route('api.appointMaintenance') }}">
                <div class="a_form1">
                    <input class="txt01" type="text" name="ou_st_id" placeholder="请选择专营店／输入地址"/>
                    ...
                    <input class="txt07" type="text" name="ou_date" placeholder="2016,4,19" onfocus="(this.type='date')" />
