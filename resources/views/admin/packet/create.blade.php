    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>'admin.wechat-packet.store','role'=>'form','class'=>'form-horizontal',]) !!}

                    <div class="form-group @if($errors->first('act_name')) has-error @endif">
                        <label class="col-sm-2 control-label" for="act_name" >活动名称</label>

                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ old('act_name') }}" name="act_name" id="act_name" placeholder="@if($errors->first('act_name')) {{$errors->first('act_name')}} @else 活动名称 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('times')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ old('times') }}"  name="times" id="times" placeholder="@if($errors->first('times')) {{$errors->first('times')}} @else 可用次数 @endif">
                        </div>
                    ...
                    <div class="form-group @if($errors->first('sign_key')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" value="{{ old('sign_key') }}"  name="sign_key" id="sign_key" placeholder="@if($errors->first('sign_key')) {{$errors->first('sign_key')}} @else 签名密钥(不可为中文) @endif">
                        </div>
