...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-default">
            <a class="btn btn-primary" href="{{ route('admin.station.create') }}">添加维修站</a>
        </div>
    </div>
</div>
                    ...
                    <table class="table table-bordered table-striped" id="example-2">
                        ...
                        <tbody class="middle-align">
                            ...
                            <tr>
                                ...
                                <td>{{ $item->tel1 }}</td>
                                <td>{{ $item->tel2 }}</td>
                                <td>{{ $item->state?'已关闭':'运营中' }}</td>
                                <td>
                                    <a href="{{route('admin.station.edit',$item->id)}}" class="btn btn-secondary btn-sm btn-icon icon-left">
                                        编辑
                                    </a>

                                    {!! Form::open(['route'=>['admin.station.destroy',$item->id],'role'=>'form','class'=>'form-horizontal','method'=>'delete','style'=>'display:inline']) !!}
