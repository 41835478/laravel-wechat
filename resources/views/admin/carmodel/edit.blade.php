            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>['admin.carmodel.update',$carmodel->id],'role'=>'form','class'=>'form-horizontal','method'=>'patch']) !!}
                    ...
                    <div class="form-group @if($errors->first('models')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="models" id="models" value="{{$carmodel->models}}" placeholder="@if($errors->first('models')) {{$errors->first('models')}} @else 车型名称 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('images')) has-error @endif">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="images" value="{{ $carmodel->images }}" class="form-control"  id="pic_url" placeholder="@if($errors->first('images')) {{$errors->first('images')}} @else 图片地址 @endif">
                        </div>
                        <div class="col-sm-1">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10" id="preview_pic">
                            <img src="{{ url($carmodel->images) }}" width="100%"/>
                        </div>
                    ...
                    <div class="form-group @if($errors->first('tel')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="tel" id="tel" value="{{$carmodel->tel}}" placeholder="@if($errors->first('tel')) {{$errors->first('tel')}} @else 联系热线 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('path')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="path" id="path" value="{{$carmodel->path}}" placeholder="@if($errors->first('path')) {{$errors->first('path')}} @else 车型详情地址链接 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::textarea('txt',$carmodel->txt,[
                                'class'=>'form-control',
                                'placeholder'=>'正文'
                            ]) !!}
                        </div>
