            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group @if($errors->first('l_img')) has-error @endif">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="l_img" class="form-control"  id="pic_url" placeholder="@if($errors->first('l_img')) {{$errors->first('l_img')}} @else 图片地址 @endif">
                        </div>
                        <div class="col-sm-1">
                    ...
                    <div class="form-group @if($errors->first('l_asc')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="l_asc" id="l_asc" placeholder="@if($errors->first('l_asc')) {{$errors->first('l_asc')}} @else 排序 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('l_address')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="l_address" id="l_address" placeholder="@if($errors->first('l_address')) {{$errors->first('l_address')}} @else 地址 @endif">
                        </div>
                    </div>
                        ...
                        <div class="col-sm-10">
                            ...
                            <p>
                                <label class="radio-inline">
                                    <input type="radio" name="l_state" value="0" checked>
                                    正常
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="l_state" value="1">
                                    归档
                                </label>
