    ...
    <div class="col-sm-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['route'=>'admin.wechat-staff.store','role'=>'form','class'=>'form-horizontal',]) !!}
                    ...
                    <div class="form-group @if($errors->first('kf_account')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="kf_account" id="kf_account" placeholder="@if($errors->first('kf_account')) {{$errors->first('kf_account')}} @else 格式:帐号前缀@公众号微信号 @endif">
                        </div>
                    </div>
                    ...
                    <div class="form-group @if($errors->first('nickname')) has-error @endif">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="nickname" id="nickname" placeholder="@if($errors->first('nickname')) {{$errors->first('nickname')}} @else 客服昵称 @endif">
                        </div>
                    </div>
